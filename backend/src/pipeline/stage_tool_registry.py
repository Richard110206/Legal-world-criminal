...
REGISTERED_STAGE_TOOL_FACTORIES: dict[str, ToolFactory] = {
    ...
    "draft_first_instance_criminal_judgment": create_first_instance_criminal_judgment_drafting_tool,
    "draft_second_instance_criminal_judgment": create_second_instance_criminal_judgment_drafting_tool,
}
