...
DOCUMENT_TYPE_ALIASES = {
    "defense_opinion": "defense_opinion",
    "DS": "defense_opinion",
    "辩护词": "defense_opinion",
}
...
DOCUMENT_SKILL_SPECS = {
    "defense_opinion": {
        "skill_id": DEFENSE_OPINION_SKILL_ID,
        "name": "刑事辩护词",
        "description": "根据玩家提示、草稿和案件上下文辅助生成《刑事辩护词》草稿。",
        "title": "《刑事辩护词》",
    },
}
...
def normalize_phase1_document_type(document_type: str) -> str:
    ...
    if not normalized:
        raise ValueError("Player document assist only supports defense_opinion/DS.")
    return normalized
