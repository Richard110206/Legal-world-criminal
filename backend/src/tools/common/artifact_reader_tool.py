...
_ARTIFACT_DESCRIPTION_MAP = {
    ...
    "LC_result.json": "委托洽谈阶段结果，通常含委托人家属与辩护律师的对话历史。",
    "INV_result.json": "侦查阶段结果，含会见与取保候审评估。",
    "PR_result.json": "审查起诉阶段结果，含阅卷与辩护意见。",
    "DS_result.json": "辩护词草拟阶段结果。",
    "CR_result.json": "刑事一审庭审或判决结果。",
    "CRA_result.json": "刑事二审庭审或判决结果。",
}
